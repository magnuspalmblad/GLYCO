...
hits <-
  epmc_search(
    '(EXT_ID:34191522) OR (EXT_ID:32236654) OR (EXT_ID:35193013) OR (EXT_ID:34834160) OR (EXT_ID:34299586) OR (EXT_ID:36697781) OR (EXT_ID:36131114) OR (EXT_ID:35804766) OR (EXT_ID:35091091) OR (EXT_ID:35945033) OR (EXT_ID:36189210) OR (EXT_ID:36385894) OR (EXT_ID:35798744) OR (EXT_ID:36607393) OR (EXT_ID:35245040) OR (EXT_ID:36982475) OR (EXT_ID:36845686) OR (EXT_ID:37383151) OR (EXT_ID:37753295) OR (EXT_ID:37147936)',
    synonym = FALSE,
    output = 'raw',
    limit = 300
  )
